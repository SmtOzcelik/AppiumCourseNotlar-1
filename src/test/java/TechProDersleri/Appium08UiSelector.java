...
public class Appium08UiSelector {
    ...
    public void test() throws MalformedURLException, InterruptedException {
        ...
        driver.findElement(AppiumBy.androidUIAutomator("UiSelector().resourceId(\"com.davemac327.gesture.tool:id/done\").enabled(false)")).getAttribute("enabled");
        ...
        driver.findElement(AppiumBy.id("com.davemac327.gesture.tool:id/gestures_overlay")).click();
        Thread.sleep(3);
        ...
        driver.findElement(AppiumBy.androidUIAutomator("UiSelector().resourceId(\"com.davemac327.gesture.tool:id/done\").enabled(true)")).getAttribute("enabled");
